								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="form-group">
											<label>제목</label> 
											<input id="nttSj" name="nttSj" value="RE : ${result.nttSj}" type="text" class="form-control"
												placeholder="" >
									...
									<div class="buttons">
										...
										<button type="button" onclick="javascript:fn_egov_insertBoard(); return false;" class="btn btn-info">답변쓰기</button>
									</div>
								</div>
